...
SECRET_KEY = 'django-insecure-xjb$)v%)z@@*3-ihwjk#cg^j42eu7v_1rulcxaw**rnpqtl0bs'
...
LOGIN_REDIRECT_URL = '/admin/login/?next=/admin/app_tcc/user/'
LOGOUT_REDIRECT_URL = '/admin/login/?next=/admin/app_tcc/user/'